...
function datos_ue($fecha, $tabla_voto, $tabla_lista, $sigla_cat){
    ...
    foreach($datos as $un_registro){
        if($nom_ue != null && $nom_ue != $un_registro['sigla_ue']){
            $this->crear_json_ue($fecha, $sigla_cat, $claustros, $fila_total2, $data, $ponderados, $empadronados, $bnr, $nom_ue, $m_enviadas, $m_confirmadas, $m_total);
...
function votos_por_ue($fecha, $tabla_voto, $tabla_lista, $id_tipo, $nom_claustro) {
    ...
    //Calcula la fecha maxima de modificacion siempre que existan mesas sin 
    //estado definitivo para la fecha ingresada
