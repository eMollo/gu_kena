...
class tp_gu_kena extends toba_tp_basico
{
	...
	function pre_contenido()
	{
		echo "<div class='login-titulo'>". toba_recurso::imagen_proyecto("inicio.png",true);
				echo "<div style='font-weight: bold; font-size:30px;'>2018</div>";
...
//        echo "<div>".utf8_decode("versión")." ".toba::proyecto()->get_version()."</div>";
				...
				echo "<div><a style='color:blue;font-size:15px;' href='Instructivo carga electronica 2018-ASMA.pdf'>Ver Instructivo</a></div>";
		echo "</div>";                
